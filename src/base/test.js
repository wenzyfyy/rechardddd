// Bu dosya botu test etmek içindir.
...
const { testBotid, testToken } = require("./settings.json");
...
setTimeout(async () => {
  rest.put(Routes.applicationCommands(testBotid), { body: commands }).catch(console.error);
}, 500);
